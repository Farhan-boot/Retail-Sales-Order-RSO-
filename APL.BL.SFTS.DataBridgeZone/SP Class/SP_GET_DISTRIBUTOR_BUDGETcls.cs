...
namespace APL.BL.SFTS.DataBridgeZone
{
    [Serializable()]
    [DataContract]
    public class SP_GET_DISTRIBUTOR_BUDGETcls : ObjectMakerFromOracleSP.ISpClassEntity
    {
        [DataMember]
        ...
        {
            SP_GET_DISTRIBUTOR_BUDGETcls entity = new SP_GET_DISTRIBUTOR_BUDGETcls();

            if (values[0].GetType() != typeof(System.DBNull))
                entity.ROW_NUMBER = Convert.ToDecimal(values[0]);

            if (values[1].GetType() != typeof(System.DBNull))
                entity.DISTRIBUTOR_BUDGET_ID = Convert.ToDecimal(values[1]);

            if (values[2].GetType() != typeof(System.DBNull))
                entity.TARGET_SETUP_ID = Convert.ToDecimal(values[2]);

            if (values[3].GetType() != typeof(System.DBNull))
                entity.GROSS_BUDGET_ID = Convert.ToDecimal(values[3]);

            if (values[4].GetType() != typeof(System.DBNull))
                entity.DISTRIBUTOR_ID = Convert.ToDecimal(values[4]);

            if (values[5].GetType() != typeof(System.DBNull))
                entity.START_DATE = Convert.ToDateTime(values[5]);

            if (values[6].GetType() != typeof(System.DBNull))
                entity.END_DATE = Convert.ToDateTime(values[6]);

            if (values[7].GetType() != typeof(System.DBNull))
                entity.MONTH_DATE = Convert.ToDateTime(values[7]);

            if (values[8].GetType() != typeof(System.DBNull))
                entity.BUDGET_AMOUNT = Convert.ToDecimal(values[8]);

            if (values[9].GetType() != typeof(System.DBNull))
                entity.ACHIVEMENT_AMOUNT = Convert.ToDecimal(values[9]);

            if (values[10].GetType() != typeof(System.DBNull))
                entity.COMMISSION_AMOUNT = Convert.ToDecimal(values[10]);
            ...
            if (values[12].GetType() != typeof(System.DBNull))
                entity.PRODUCT_CATEGORY_ID = Convert.ToDecimal(values[12]);

            if (values[13].GetType() != typeof(System.DBNull))
                entity.PRODUCT_ID_LIST = Convert.ToString(values[13]);

            if (values[14].GetType() != typeof(System.DBNull))
                entity.BUDGET_UNIT = Convert.ToDecimal(values[14]);
