...
namespace APL.BL.SFTS.DataBridgeZone
{
    [Serializable()]
    [DataContract]
    public class SP_GET_BEST_RETAILER_PRACTICE : ObjectMakerFromOracleSP.ISpClassEntity
    {       
        [DataMember]
        public Decimal BEST_PRACTICES_RETAILER_ID { get; set; }
        ...
        {
            SP_GET_BEST_RETAILER_PRACTICE entity = new SP_GET_BEST_RETAILER_PRACTICE();
            if (values[0].GetType() != typeof(System.DBNull))
                entity.BEST_PRACTICES_RETAILER_ID = Convert.ToDecimal(values[0]);
