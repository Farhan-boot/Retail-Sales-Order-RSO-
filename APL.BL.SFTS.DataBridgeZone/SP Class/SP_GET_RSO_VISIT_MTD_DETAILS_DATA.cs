...
namespace APL.BL.SFTS.DataBridgeZone
{
    [Serializable()]
    [DataContract]
   public class SP_GET_RSO_VISIT_MTD_DETAILS_DATA : ObjectMakerFromOracleSP.ISpClassEntity
    {
        [DataMember]
        ...
        {
            SP_GET_RSO_VISIT_MTD_DETAILS_DATA entity = new SP_GET_RSO_VISIT_MTD_DETAILS_DATA();
