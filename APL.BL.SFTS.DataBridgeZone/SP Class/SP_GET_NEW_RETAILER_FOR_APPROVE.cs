...
namespace APL.BL.SFTS.DataBridgeZone
{
    [Serializable()]
    [DataContract]
    public class SP_GET_NEW_RETAILER_FOR_APPROVE : ObjectMakerFromOracleSP.ISpClassEntity
    {
        [DataMember]
        ...
        {
            SP_GET_NEW_RETAILER_FOR_APPROVE entity = new SP_GET_NEW_RETAILER_FOR_APPROVE();
