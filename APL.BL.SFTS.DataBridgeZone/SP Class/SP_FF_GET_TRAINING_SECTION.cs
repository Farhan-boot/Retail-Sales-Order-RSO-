...
namespace APL.BL.SFTS.DataBridgeZone.SP_Class
{
    [Serializable()]
    [DataContract]
    public class SP_FF_GET_TRAINING_SECTION : ObjectMakerFromOracleSP.ISpClassEntity
    {
        [DataMember]
        ...
        {
            SP_FF_GET_TRAINING_SECTION entity = new SP_FF_GET_TRAINING_SECTION();
            ...
            if (values[3].GetType() != typeof(System.DBNull))
                entity.UPLOADED_DATE = Convert.ToDateTime(values[3]);
