...
namespace APL.BL.SFTS.DataBridgeZone
{
	[Serializable()]
	[DataContract]
	public class SP_GET_FF_RSO_EARNING_SALAY_FILE : ObjectMakerFromOracleSP.ISpClassEntity
	{
		[DataMember]
		...
		public object MapToEntity(object[] values)
		{
			...
			SP_GET_FF_RSO_EARNING_SALAY_FILE entity = new SP_GET_FF_RSO_EARNING_SALAY_FILE();
