...
namespace APL.BL.SFTS.DataBridgeZone
{
    [Serializable()]
    [DataContract]
    public class SP_GET_DISTRIBUTOR_TARGET_FILE : ObjectMakerFromOracleSP.ISpClassEntity
    {     
        [DataMember]
        ...
        {
            SP_GET_DISTRIBUTOR_TARGET_FILE entity = new SP_GET_DISTRIBUTOR_TARGET_FILE();
