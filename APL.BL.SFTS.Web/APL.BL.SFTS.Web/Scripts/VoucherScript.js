$(function() {
    ...
    $("#debit").on('keyup mouseup', function() {
        sumDebit1('debit', 'credit');
    });
    $("#credit").on('keyup mouseup', function() {
    ...
    $('#add').click(function () {
        ...
        if (isAllValid) {
            ...
            $('#add', $newRow).removeClass('btn-success').addClass('btn-danger remove');
    ...
    $('#voucherDetails').on('click', '.remove', function () {
