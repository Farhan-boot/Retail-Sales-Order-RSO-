app.service('YarnService', function ($http) {
    ...
    this.GetAcDetailsID = function (apiRoute, page, pageSize, isPaging, ComapnyID, itemGroupID) {

        urlGet = apiRoute + page + '/' + pageSize + '/' + isPaging + '/' + ComapnyID + '/' + itemGroupID;
        return $http.get(urlGet);
    }
    ...
    this.PostMultiData = function (apiRoute, cmnParam) {
        var request = $.ajax({
            method: "post",
            url: apiRoute,
            data: cmnParam,
