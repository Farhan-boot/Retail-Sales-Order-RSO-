...
app.controller('TargetSetupCtlr', ['$scope', 'crudService', 'conversion', '$filter', '$localStorage', 'uiGridConstants',
    function ($scope, crudService, conversion, $filter, $localStorage, uiGridConstants) {
        ...
        var baseUrl = DirectoryKey +'/SFTS/api/Rsofixsalary/';
        var isExisting = 0;
        var page = 0;
        var pageSize = 100;
        var isPaging = 0;
     ...
     //*********----Start File Upload----*******************
        ...
        $scope.ExportExcelFile = function () {
            ...
            TargetItems.then(function (response) {
                if ($scope.TargetPeriod > 0)
                    window.open('/mDMS_NEW/UserFiles/RSO_SALARY/' + response.data, '_blank', '');
                else 
                    window.open('/mDMS_NEW/UserFiles/RSO_SALARY/TEMPLATE/' + response.data, '_blank', '');
            },
        ...
        function loadAllTarget(isPaging) {
            ...
            $scope.gridOptionsTargetSetup = {
                ...
                columnDefs: [
                    ...
                    { name: "BANK_AC", displayName: "BANK AC", title: "BANK AC", width: '15%', headerCellClass: $scope.highlightFilteredHeader },
                    { name: "DOB", displayName: "Date of Birth", title: "Date of Birth", width: '10%', headerCellClass: $scope.highlightFilteredHeader },
                    { name: "JOIN_DATE", displayName: "JOIN DATE", title: "JOIN DATE", width: '10%', headerCellClass: $scope.highlightFilteredHeader },
                    { name: "WORKING_DAY", displayName: "WORKING DAY", title: "WORKING DAY", width: '10%', headerCellClass: $scope.highlightFilteredHeader },
                    { name: "SALAY_YEAR_MONTH", displayName: "SALAY_MONTH", title: "SALAY_MONTH", width: '10%', headerCellClass: $scope.highlightFilteredHeader },
                    { name: "TOTAL_SALARY", displayName: "TOTAL SALARY", title: "TOTAL SALARY", width: '10%', headerCellClass: $scope.highlightFilteredHeader },
        ...
        $scope.clear = function () {
            ...
            $("#ddlTargetPeriod").select2("data", { id: 0, text: '--Select Salary Period--' });
