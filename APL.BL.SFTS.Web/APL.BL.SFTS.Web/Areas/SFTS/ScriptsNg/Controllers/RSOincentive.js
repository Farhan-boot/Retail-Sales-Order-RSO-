...
app.controller('TargetSetupCtlr', ['$scope', 'crudService', 'conversion', '$filter', '$localStorage', 'uiGridConstants',
    function ($scope, crudService, conversion, $filter, $localStorage, uiGridConstants) {
        ...
        var baseUrl = DirectoryKey +'/SFTS/api/RSOincentive/';
        var isExisting = 0;
        var page = 0;
        var pageSize = 100;
        var isPaging = 0;
        ...
        $scope.PageTitle = 'RSO Incentive';
        $scope.ListTitle = 'Incentive List';
        $scope.waitText = ''
     ...
     //*********----Start File Upload----*******************
        ...
        $scope.ExportExcelFile = function () {
            ...
            TargetItems.then(function (response) {
                window.open('/UserFiles/VFOCUS/CAMP_DATA/' + response.data, '_blank', '');
            },
                function (error) {
                    console.log("Error: " + error);
                });
        ...
        function loadAllTarget(isPaging) {
            ...
            $scope.gridOptionsTargetSetup = {
                ...
                columnDefs: [
                    { name: "RSOCODE", displayName: "RSO CODE", title: "RSO CODE", width: '40%', headerCellClass: $scope.highlightFilteredHeader },
                    //{ name: "SALAY_YEAR_MONTH", displayName: "Period", title: "Period", width: '16%', headerCellClass: $scope.highlightFilteredHeader },
                    { name: "BASE_YEAR_MONTH", displayName: "BASE_YEAR_MONTH", title: "BASE_YEAR_MONTH", width: '10%', headerCellClass: $scope.highlightFilteredHeader },
                    { name: "TYPE", displayName: "TYPE", title: "TYPE", width: '7%', headerCellClass: $scope.highlightFilteredHeader },
                    { name: "INCENTIVE", displayName: "INCENTIVE", title: "INCENTIVE", width: '17%', headerCellClass: $scope.highlightFilteredHeader },
                    { name: "REMARKS", displayName: "REMARKS", title: "REMARKS", width: '17%', headerCellClass: $scope.highlightFilteredHeader },

                    {
                        ...
                        cellTemplate: '<div style="padding-left: 12px">' +
                ...
                enableGridMenu: true,
                enableSelectAll: true,
                exporterCsvFilename: 'RSO_INCENTIVE.csv',
