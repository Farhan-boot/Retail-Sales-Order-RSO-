...
app.controller('TargetSetupCtlr', ['$scope', 'crudService', 'conversion', '$filter', '$localStorage', 'uiGridConstants',
    function ($scope, crudService, conversion, $filter, $localStorage, uiGridConstants) {
        ...
        var baseUrl = '/SFTS/api/TargetSetup/';
        var isExisting = 0;
        var page = 0;
        var pageSize = 100;
        var isPaging = 0;
        ...
        function loadRoles(isPaging) {
            ...
            var apiRoute = '/SFTS/api/CmnDropdown/GetRoles/';
            var cmnParam = "[" + JSON.stringify(objcmnParam) + "]";
        ...
        $scope.ExportExcelFile = function () {
            ...
            TargetItems.then(function (response) {
                window.open('/UserFiles/TargetExcel/' + response.data, '_blank', '');
            },
            function (error) {
                console.log("Error: " + error);
            });
        ...
        function loadTargetItems(isPaging) {
            ...
            var apiRoute = '/SFTS/api/CmnDropdown/GetTargetItem/';
            var cmnParam = "[" + JSON.stringify(objcmnParam) + "]";
        ...
        $scope.loadTargetPeriod = function (isPaging) {
            ...
            var apiRoute = '/SFTS/api/CmnDropdown/GetTargetPeriod/';
            var cmnParam = "[" + JSON.stringify(objcmnParam) + "]";
