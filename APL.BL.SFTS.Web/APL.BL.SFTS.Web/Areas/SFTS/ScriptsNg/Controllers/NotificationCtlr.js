...
app.controller('NotificationCtlr', ['$scope', 'crudService', 'conversion', '$filter', '$localStorage', 'uiGridConstants',
    function ($scope, crudService, conversion, $filter, $localStorage, uiGridConstants) {
        var baseUrl = DirectoryKey +'/SFTS/api/Notification/';
        var isExisting = 0;
        var page = 0;
        var pageSize = 100;
        var isPaging = 0;
        ...
        $scope.PageTitle = 'Add New Notification';
        ...
        $scope.ShowHide = function () {
            ...
            if ($scope.IsHidden == true) {
                ...
                $scope.btnSaveText = "Save";
                $scope.PageTitle = 'Existing Notification';
                $scope.IsShow = false;
        ...
        function loadCenterTypes(isPaging) {
            ...
            var apiRoute = DirectoryKey + '/SFTS/api/CmnDropdown/GetNotificationTypes/';
            var cmnParam = "[" + JSON.stringify(objcmnParam) + "]";
