...
app.controller('TargetSetupCtlr', ['$scope', 'crudService', 'conversion', '$filter', '$localStorage', 'uiGridConstants',
    function ($scope, crudService, conversion, $filter, $localStorage, uiGridConstants) {
        ...
        var baseUrl = DirectoryKey +'/SFTS/api/RsoSalary/';
        var isExisting = 0;
        var page = 0;
        var pageSize = 100;
        var isPaging = 0;
       ...
       // $scope.IsTargetPeriodDisabled = false;
        ...
        function SaveUploadedExcel() {
            ...
            // ADD LISTENERS.
            var apiRoute = baseUrl + 'SaveUpdateSalaryExcel/';
        ...
        $scope.ExportExcelFile = function () {
            ...
            var apiRoute = baseUrl + 'ExportSalaryExcel/';
        ...
        function loadAllTarget(isPaging) {
            ...
            $scope.gridOptionsTargetSetup = {
                ...
                columnDefs: [
                    { name: "ROSCODE", displayName: "RSO CODE", title: "RSO CODE", width: '40%', headerCellClass: $scope.highlightFilteredHeader },
                    //{ name: "SALAY_YEAR_MONTH", displayName: "Period", title: "Period", width: '16%', headerCellClass: $scope.highlightFilteredHeader },
                    { name: "BANK_NAME", displayName: "BANK NAME", title: "BANK NAME", width: '10%', headerCellClass: $scope.highlightFilteredHeader },
                    { name: "BANK_AC", displayName: "BANK AC", title: "BANK AC", width: '7%', headerCellClass: $scope.highlightFilteredHeader },
                    { name: "DOB", displayName: "Date of Birth", title: "Date of Birth", width: '17%', headerCellClass: $scope.highlightFilteredHeader },
                    { name: "JOIN_DATE", displayName: "JOIN DATE", title: "JOIN DATE", width: '17%', headerCellClass: $scope.highlightFilteredHeader },
                    { name: "WORKING_DAY", displayName: "WORKING DAY", title: "WORKING DAY", width: '17%', headerCellClass: $scope.highlightFilteredHeader },
                    { name: "SALAY_YEAR_MONTH", displayName: "SALAY_MONTH", title: "SALAY_MONTH", width: '17%', headerCellClass: $scope.highlightFilteredHeader },
                    { name: "TOTAL_SALARY", displayName: "TOTAL SALARY", title: "TOTAL SALARY", width: '17%', headerCellClass: $scope.highlightFilteredHeader },
                    { name: "VENDOR", displayName: "VENDOR", title: "VENDOR", width: '17%', headerCellClass: $scope.highlightFilteredHeader },
                    { name: "STATUS", displayName: "STATUS", title: "STATUS", width: '17%', headerCellClass: $scope.highlightFilteredHeader },
                    {
                        name: 'Action',
                        displayName: "Action",
            ...
            var apiRoute = baseUrl + 'GetAllSalary/';
        ...
        $scope.SaveTargetSetup = function () {
            ...
            var apiRoute = baseUrl + 'SaveSalary/';
