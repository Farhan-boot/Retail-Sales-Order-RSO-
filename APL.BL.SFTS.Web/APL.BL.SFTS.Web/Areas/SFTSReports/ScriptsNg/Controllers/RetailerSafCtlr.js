...
app.controller('RetailerSafCtlr', ['$scope', 'crudService', 'conversion', '$filter', '$localStorage', 'uiGridConstants',
    function ($scope, crudService, conversion, $filter, $localStorage, uiGridConstants) {
        ...
        $scope.GetRetailerSaf = function () {
            $scope.gridOptionsRetailerSaf.enableFiltering = false;
            $scope.gridOptionsRetailerSaf.enableGridMenu = true;

            //For Loading
            $scope.loaderMoreRetailerSaf = true;
            $scope.lblMessageForRetailerSaf = 'loading please wait....!';
            ...
            $scope.gridOptionsRetailerSaf = {
                ...
                columnDefs: [
                    ...
                    { name: "PREPAID_ACTIVATION_THIS_MONTH", displayName: "Prepaid Activation This Month", title: "Prepaid Activation This Month", width: '20%', headerCellClass: $scope.highlightFilteredHeader },
                    { name: "PREPAID_SAF_PENDING_THIS_MONTH", displayName: "Prepaid SAF Pending This Month", title: "Prepaid SAF Pending This Month", width: '20%', headerCellClass: $scope.highlightFilteredHeader },
                    { name: "POSTPAID_ACTIVATION_THIS_MONTH", displayName: "Postpaid Activation This Month", title: "Postpaid Activation This Month", width: '20%', headerCellClass: $scope.highlightFilteredHeader },
                    { name: "POSTPAID_SAF_PENDING_THIS_MONTH", displayName: "Postpaid SAF Pending This Month", title: "Postpaid SAF Pending This Month", width: '20%', headerCellClass: $scope.highlightFilteredHeader },
                    { name: "TOTAL_SAF_PENDING_PREPAID", displayName: "Total SAF Pending Prepaid", title: "Total SAF Pending Prepaid", width: '20%', headerCellClass: $scope.highlightFilteredHeader },
                    { name: "TOTAL_SAF_PENDING_POSTPAID", displayName: "Total SAF Pending Postpaid", title: "Total SAF Pending Postpaid", width: '20%', headerCellClass: $scope.highlightFilteredHeader },
                ...
                enableGridMenu: true,
                enableSelectAll: true,
                exporterCsvFilename: 'Retailer SAF.csv',
                exporterPdfDefaultStyle: { fontSize: 9 },
                exporterPdfTableStyle: { margin: [30, 30, 30, 30] },
                exporterPdfTableHeaderStyle: { fontSize: 10, bold: true, italics: true, color: 'red' },
                exporterPdfHeader: { text: "Retailer SAF", style: 'headerStyle' },
            ...
            var apiRoute = baseUrl + 'GetRetailerSaf/';
            ...
            tva.then(function (response) {
                $scope.tvaList = response.data.retailerSaf;
                $scope.gridOptionsRetailerSaf.data = response.data.retailerSaf;
                $scope.loaderMoreRetailerSaf = false;
            },
            function (error) {
                console.log("Error: " + error);
            });
