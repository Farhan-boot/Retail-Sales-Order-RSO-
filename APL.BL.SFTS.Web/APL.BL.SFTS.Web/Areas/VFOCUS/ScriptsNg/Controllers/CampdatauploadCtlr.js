...
app.controller('TargetSetupCtlr', ['$scope', 'crudService', 'conversion', '$filter', '$localStorage', 'uiGridConstants',
    function ($scope, crudService, conversion, $filter, $localStorage, uiGridConstants) {
        ...
        var baseUrl = DirectoryKey +'/VFocusAPI/api/campdata/';
        var isExisting = 0;
        var page = 0;
        var pageSize = 100;
        var isPaging = 0;
       ...
       // $scope.IsTargetPeriodDisabled = false;
        ...
        $scope.PageTitle = 'Camp Data';
        $scope.ListTitle = 'Camp Data List';
        $scope.waitText = ''
        ...
        function loadAllTarget(isPaging) {
            ...
            $scope.gridOptionsTargetSetup = {
                ...
                columnDefs: [
                    { name: "ID", displayName: "SL", title: "SL", width: '10%', headerCellClass: $scope.highlightFilteredHeader },
                    { name: "CAMP_NAME", displayName: "CAMP NAME", title: "CAMP NAME", width: '16%', headerCellClass: $scope.highlightFilteredHeader },
                    { name: "DD_CODE", displayName: "DD CODE", title: "DD CODE", width: '10%', headerCellClass: $scope.highlightFilteredHeader },
                    { name: "TARGET", displayName: "TARGET", title: "TARGET", width: '10%', headerCellClass: $scope.highlightFilteredHeader },
                    { name: "ACIEVEMENNTS", displayName: "ACIEVEMENNTS", title: "ACIEVEMENNTS", width: '10%', headerCellClass: $scope.highlightFilteredHeader },
                    { name: "UPLOAD_DATE", displayName: "UPLOAD_DATE", title: "UPLOAD_DATE", width: '17%', headerCellClass: $scope.highlightFilteredHeader },
                   /* {
                        name: 'Action',
                        displayName: "Action",
