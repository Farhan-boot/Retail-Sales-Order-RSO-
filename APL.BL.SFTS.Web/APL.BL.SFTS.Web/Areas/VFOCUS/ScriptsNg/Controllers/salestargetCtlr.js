...
app.controller('TargetSetupCtlr', ['$scope', 'crudService', 'conversion', '$filter', '$localStorage', 'uiGridConstants',
    function ($scope, crudService, conversion, $filter, $localStorage, uiGridConstants) {
        ...
        var baseUrl = DirectoryKey +'/VFocusAPI/api/vfocusdata/';
        var isExisting = 0;
        var page = 0;
        var pageSize = 100;
        var isPaging = 0;
       ...
       // $scope.IsTargetPeriodDisabled = false;
        ...
        $scope.PageTitle = 'Sales target';
        $scope.ListTitle = 'Sales target List';
        $scope.waitText = ''
        ...
        var actionCallback = function (response) {
            ...
            if (IsInvalidCode == false) {
                ...
                ////debugger;
                //alert(InvalidCode); debugger;
                $scope.IsInProgress = false;
                $scope.IsNotFoundShow = true;
                $scope.ProgressStatus = 0;
                $scope.NotFoundMsg = InvalidCode + " "
                document.getElementById('files').value = '';
        ...
        $scope.ExportExcelFile = function () {
            ...
            TargetItems.then(function (response) {
                window.open('/UserFiles/VFOCUS/SALES_DATA/' + response.data, '_blank', '');
            },
                function (error) {
                    console.log("Error: " + error);
                });
        ...
        function loadAllTarget(isPaging) {
            ...
            $scope.gridOptionsTargetSetup = {
                ...
                columnDefs: [
                    { name: "TARGET_DATE", displayName: "TARGET_DATE", title: "TARGET_DATE", width: '10%', headerCellClass: $scope.highlightFilteredHeader },
                    { name: "REGION", displayName: "REGION", title: "REGION", width: '10%', headerCellClass: $scope.highlightFilteredHeader },
                    { name: "DD_CODE", displayName: "DD_CODE", title: "DD_CODE", width: '10%', headerCellClass: $scope.highlightFilteredHeader },
                    { name: "DD_NAME", displayName: "DD_NAME", title: "DD_NAME", width: '10%', headerCellClass: $scope.highlightFilteredHeader },
                    { name: "RP_SIM", displayName: "RP_SIM", title: "RP_SIM", width: '7%', headerCellClass: $scope.highlightFilteredHeader },
                    { name: "RP_EV", displayName: "RP_EV", title: "RP_EV", width: '7%', headerCellClass: $scope.highlightFilteredHeader },


                    { name: "GA", displayName: "GA", title: "GA", width: '7%', headerCellClass: $scope.highlightFilteredHeader },
                    { name: "DS_EV", displayName: "DS_EV", title: "DS_EV", width: '7%', headerCellClass: $scope.highlightFilteredHeader },
                    { name: "DS_SC", displayName: "DS_SC", title: "DS_SC", width: '7%', headerCellClass: $scope.highlightFilteredHeader },
                    { name: "TOTAL_DS", displayName: "TOTAL_DS", title: "TOTAL_DS", width: '7%', headerCellClass: $scope.highlightFilteredHeader },
                    { name: "RECH_SC", displayName: "RECH_SC", title: "RECH_SC", width: '7%', headerCellClass: $scope.highlightFilteredHeader },
                    { name: "RECH_EV", displayName: "RECH_EV", title: "RECH_EV", width: '7%', headerCellClass: $scope.highlightFilteredHeader },
                    { name: "TOTAL_RECH", displayName: "TOTAL_RECH", title: "TOTAL_RECH", width: '10%', headerCellClass: $scope.highlightFilteredHeader },
                ...
                enableGridMenu: true,
                enableSelectAll: true,
                exporterCsvFilename: 'SALES_TARGET.csv',
