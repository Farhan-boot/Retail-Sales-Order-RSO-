...
namespace APL.BL.SFTS.Web.Areas.SFTSApi.Custom
{
    public class PostVariableParameterBinding : HttpParameterBinding
    {
        private const string MultipleBodyParameters = "MultipleBodyParameters";

        public PostVariableParameterBinding(HttpParameterDescriptor descriptor)
            : base(descriptor)
        {
        }
        ...
        public static HttpParameterBinding HookupParameterBinding(HttpParameterDescriptor descriptor)
        {
                ...
                supportedMethods.Contains(HttpMethod.Put))
            {
                ...
                if (supportedTypes.Where(typ => typ == descriptor.ParameterType).Count() > 0)
                    return new PostVariableParameterBinding(descriptor);
            }
